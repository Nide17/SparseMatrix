...
// representing a matrix by three (one-dimensional) arrays,
...
class CSRMatrix
{
	...
	CSRMatrix(int numRows, int numCols, int numNonZero)
	{
		rows = numRows;
		cols = numCols;
		nnz = numNonZero;
...
public:
	...
	SparseMatrix(int numRows, int numCols, int numNonZero);
	/**
